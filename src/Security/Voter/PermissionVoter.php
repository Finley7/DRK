...
class PermissionVoter extends Voter
{
    ...
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token)
    {
        ...
        return (in_array($attribute, $this->_userPermissions, true));
    }
    ...
    protected function getUserPermissions() : void {
        ...
        if($this->isLoggedIn()) {
            ...
            foreach($permissions as $permission) {
                $this->_userPermissions[] = $permission['name'];
            }
        }
    }
    ...
    private function isLoggedIn() {
        return !($this->tokenStorage->getToken()->getUser() === "anon." || $this->tokenStorage->getToken()->getUser() == null);
    }
}
